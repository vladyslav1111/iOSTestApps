...
class HomeViewModel {
    var cards: [CardViewModel] = [
        ...
        CardViewModel(user: CardUser(name: "Nika", profesion: "Designer", age: 18, imageNames: ["lady5c", "kelly1", "lady5c", "kelly1"])),
        CardViewModel(user: CardUser(name: "Jane", profesion: "Dominatrix", age: 20, imageNames: ["kelly1"]))
    ]
}
